...
public class UpdateObjectDefinition {
    ...
    public void assert_object_name(String objectName) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getObjectName(), objectName, "Expected name " + objectName + " but got " + updateObjectResponse.get(0).getObjectName());
    }
    ...
    public void assert_object_year(String objectYear) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getYear(), objectYear, "Expected year " + objectYear + " but got " + updateObjectResponse.get(0).getData().getYear());
    }
    ...
    public void assert_object_price(double objectPrice) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getPrice(), objectPrice, "Expected price " + objectPrice + updateObjectResponse.get(0).getData().getPrice());
    }
    ...
    public void assert_object_cpu_model(String objectCPUModel) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getCpuModel(), objectCPUModel, "Expected cpu model " + objectCPUModel + " but got " + updateObjectResponse.get(0).getData().getCpuModel());
    }
    ...
    public void assert_object_hard_disk_size(String objectHardDiskSize) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getHardDiskSize(), objectHardDiskSize, "Expected hard disk size " + objectHardDiskSize + " but got " + updateObjectResponse.get(0).getData().getHardDiskSize());        
    }
    ...
    public void assert_object_capacity(String objectCapacity) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getCapacity(), objectCapacity, "Expected capacity " + objectCapacity + " but got " + updateObjectResponse.get(0).getData().getCapacity());
    }
    ...
    public void assert_object_screen_size(String objectScreenSize) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getScreenSize(), objectScreenSize, "Expected capacity " + objectScreenSize + " but got " + updateObjectResponse.get(0).getData().getScreenSize());
    }
    ...
    public void assert_object_color(String objectColor) throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        List<UpdateObjectResponse> updateObjectResponse = objectMapper.readValue(response.body().asString(), new TypeReference<List<UpdateObjectResponse>>() {});
        Assert.assertEquals(updateObjectResponse.get(0).getData().getColor(), objectColor, "Expected capacity " + objectColor + " but got " + updateObjectResponse.get(0).getData().getColor());
    }
}